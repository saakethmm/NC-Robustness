...
def main(args, config: ConfigParser):
    ...
    top5list=[]
    xlist=[]
    for step in range(args.cycle,args.epoch,args.cycle):
        ...
        model.eval()
        top1,top5=validate_pgd(test_data_loader, model, config)
    ...
    fig.savefig(str(args.checkpoint_path + "roubust.pdf"), bbox_inches='tight')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--checkpoint_path', type=str, default="/data1/xinshiduo/code/NC-Temp/res_saved/models/Robust_experiment_CIFAR100CIFAR100DataLoaderresnet18-num_classes-100-norm_layer_type-bn-conv_layer_type-conv-linear_layer_type-linear-activation_layer_type-relu-etf_fc-False-Seed=8/0818_041213/",
