...
from validate_pgd_l2 import validate_pgd
...
def main(args, config: ConfigParser):
    ...
    for step in [100]:
        ...
        model.eval()
        top1,top5,dist,distchange,dist2target,dist2targetchange,realL2,attack_step=validate_pgd(test_data_loader, model, config,fc_features)
    ...
    fig.savefig(str(args.checkpoint_path + "roubustl2.pdf"), bbox_inches='tight')
    with open((args.checkpoint_path + 'info-roubustl2.pkl'), 'wb') as f: 
