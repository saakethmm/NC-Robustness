...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--checkpoint_path', type=str, default="/data/xinshiduo/new_code/NC-Robustness/res_saved/models/Robust_experiment_CIFAR100CIFAR100DataLoaderresnet18-num_classes-100-norm_layer_type-bn-conv_layer_type-conv-linear_layer_type-linear-activation_layer_type-relu-etf_fc-False-Seed=8/0603_210839/",
