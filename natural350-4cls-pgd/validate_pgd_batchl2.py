...
def main(args, config: ConfigParser):
    ...
    for step in range(60,260,50):
        ...
        model.eval()
        before_dict,pre_dict=validate_pgd(test_data_loader, model, config,fc_features)
    ...
    with open((args.checkpoint_path + 'info-pre.pkl'), 'wb') as f: 
        pickle.dump({'before':before_list,'pre':pre_list}, f)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--checkpoint_path', type=str, default="/data1/xinshiduo/code-new/natural350-4cls-pgd/res_saved/models/ExperimentCIFAR10DataLoaderresnet18-num_classes-4-norm_layer_type-bn-conv_layer_type-conv-linear_layer_type-linear-activation_layer_type-relu-etf_fc-False-Seed=12/1006_124719/",
