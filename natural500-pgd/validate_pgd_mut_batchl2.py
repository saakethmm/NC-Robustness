...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--checkpoint_path', type=str, default="/data1/xinshiduo/code-new/natural500-pgd/res_saved/models/ExperimentCIFAR10DataLoaderresnet18-num_classes-10-norm_layer_type-bn-conv_layer_type-conv-linear_layer_type-linear-activation_layer_type-relu-etf_fc-False-Seed=12/1008_100756/",
