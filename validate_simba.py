...
def main(args, config: ConfigParser):
    ...
    checkpoint = torch.load(args.checkpoint_path+"model_epoch_"+str(200)+".pth")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, default=8, help='batch size for parallel runs')
